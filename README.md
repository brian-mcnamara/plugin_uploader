...
| <kbd>mutableRelease</kbd> - Allows overwriting/replacting releases already published to the repositorys updatePlugins.xml file. <br/><br/>**Note:** When set to false (default), the build will fail iff an entry in updatePlugins.xml matches the plugin id and version                                                                           | **Required:** false <br/> **Default:** <kbd>false</kbd> <br/> **Acceptable Values:** `true` / `false` |
